...
pilha = [] # quando atribuir a um valor null, é um aboa prática de programação, pois evita o lixo de armazenar no endereço de memória
...
def desempilhar() -> None:
    if len(pilha) > 0:
        print(f"Desempilhando {pilha[0]}\n")
        pilha.pop(0) #era so colocar pop 0 aqui
    else:
        print("Pilha vazia\n")
