    ...
    while True:
        ...
        if opcao_menu == 1:  # Menu Atendente
                ...
                if opcao_atendente == 1:  # Menu Aviões
                    ...
                    while True:
                        ...
                        if opcao_voos == 1:  # Criar voo
                            ...
                            voo.listar_voos()
                            input("Pressione Enter para continuar.")
                        elif opcao_voos == 0:  # Retornar ao menu anterior
                            break
                    ...
                    while True:
                        ...
                        if opcao_clientes == 1:  # Cadastrar cliente
                            ...
                            cliente.listar_clientes()
                            input("Pressione Enter para continuar.")
                        elif opcao_clientes == 0:  # Retornar ao menu anterior
                            break
                    ...
                    while True:
                        ...
                        if opcao_reservas == 1:  # Cadastrar reserva
                            ...
                            assento = int(input("Escolha o número do assento: "))
            ...
            while True:
                ...
                if opcao_passageiro == 1:  # Localizar reserva
                    nome_cliente = input("Digite o nome do cliente para localizar a reserva: ")
                    reserva.localizar_reserva(nome_cliente)
                    input("Pressione Enter para continuar.")
                elif opcao_passageiro == 2:  # Alterar reserva
